...
async function fetchProfile(){
  ...
  currentProfile = p;
  document.getElementById('profile-img').src = p.pic;
  document.getElementById('profile-name').innerText = p.name + ', ' + p.age;
  document.getElementById('profile-bio').innerText = p.bio + ' · ' + (p.personality || '');
}
